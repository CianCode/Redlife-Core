...
_RedClient_SkinChanger = {}

local function _U(string)
    return (string)
end
...
local components = {
    ...
    { label = _U('beard_1'),               name = 'beard_1',      value = 0,  min = 0,  zoomOffset = 0.4,  camOffset = 0.65 },
    { label = _U('beard_2'),               name = 'beard_2',      value = 0,  min = 0,  zoomOffset = 0.4,  camOffset = 0.65 },
    { label = _U('beard_3'),               name = 'beard_3',      value = 0,  min = 0,  zoomOffset = 0.4,  camOffset = 0.65 },
    { label = _U('beard_4'),               name = 'beard_4',      value = 0,  min = 0,  zoomOffset = 0.4,  camOffset = 0.65 },
...
_RedClient_SkinChanger.getMaxValues = function()
...
_RedClient_SkinChanger.applySkin = function(skin)
    local playerPed = PlayerPedId()
...
_RedClient_SkinChanger.getCharacter = function()
    return (Character)
end

_RedClient_SkinChanger.setAllToDefault = function()
    local newCharacter = {}
    for k, v in pairs(components) do
        newCharacter[v.name] = v.value
    end
    _RedClient_SkinChanger.applySkin(newCharacter)
    ClearPedProp(PlayerPedId(), 0)
    ClearPedProp(PlayerPedId(), 1)
end

_RedClient_SkinChanger.setCharacterValueWithoutChange = function(key, value)
    Character[key] = value
end

_RedLife.loadedComponent("skinchanger")
